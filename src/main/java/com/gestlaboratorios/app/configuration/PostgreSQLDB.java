package com.gestlaboratorios.app.configuration;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.gestlaboratorios.app.repository"} //El path donde se encuentra el repositorio
)
public class PostgreSQLDB {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        em.setPackagesToScan("com.gestlaboratorios.app.model");
